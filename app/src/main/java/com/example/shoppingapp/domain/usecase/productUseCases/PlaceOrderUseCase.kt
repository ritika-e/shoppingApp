...
open class PlaceOrderUseCase(private val orderRepositoryImpl: OrderRepositoryImpl) {

    // Function to place the order
  open  suspend fun execute(cartItems: List<CartItem>, totalAmount: Double, userId: String): Result<String> {
